...
async function bootstrap() {
    ...
    const bridge = even ? {
        async getStorage(key) { return even.getStorage(key); },
        async setStorage(key, value) { await even.setStorage(key, value); },
    } : null;
    ...
    window.__cardpack = { runtime, even };
}
